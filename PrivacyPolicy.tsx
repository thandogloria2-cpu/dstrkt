    ...
    <main className="bg-[#0a0a0a] min-h-screen pt-24 md:pt-40 pb-20 md:pb-32 px-6 md:px-12">
      <div className="max-w-[1000px] mx-auto">
        ...
        <header className="mb-12 md:mb-24">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black uppercase tracking-tighter italic text-white break-words">Privacy Policy.</h1>
        </header>
        ...
        <div className="space-y-12">
          {[
            { 
              ...
              content: 'We collect information you provide directly to us when you create an account, make a purchase, or communicate with us. This includes your name, email address, shipping address, and payment information.' 
            },
            { 
              title: 'Use of Information', 
              content: 'We use the information we collect to process your orders, provide customer support, and send you updates about our products and services. We may also use data for analytical purposes to improve our platform.' 
            },
            { 
              title: 'Data Security', 
              content: 'We implement industry-standard security measures to protect your personal information. All transactions are processed through secure gateways and we do not store sensitive payment data on our servers.' 
            },
            { 
              title: 'Cookies & Tracking', 
              content: 'Our website uses cookies to enhance your browsing experience and provide personalized content. You can manage your cookie preferences through your browser settings.' 
            },
            { 
